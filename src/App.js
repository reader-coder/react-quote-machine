  ...
  return (
    <div className='bg-gray-900 h-screen text-white flex flex-col items-center pt-[50px]'>
      ...
      <div className='w-[75%] mt-[100px] pb-10 flex justify-center'>
       {quote.content ? <span className='flex flex-col justify-center items-center gap-4'><p className='text-white text-2xl italic font-bold break-normal sm:text-2xl md:text-3xl'>"{quote.content}"</p> <p className='text-1xl sm:text-2xl'> - {quote.author}</p></span> :   <p className='text-2xl font-bold'>{error}</p>}
      </div>
